const AppCard = ({ app }) => {
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow border border-gray-100 w-full">
      {/* Image container with centered image */}
      <div className="relative aspect-video h-48 sm:h-40 md:h-48 overflow-hidden bg-gray-100">
        <img 
          src={app.image} 
          alt={app.name} 
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-t border-gray-100 pt-4">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <button className="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium hover:bg-gray-50 flex-1 sm:flex-none">
              Details
            </button>
            <button className="px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 flex-1 sm:flex-none">
              Buy
            </button>
          </div>
        </div>
