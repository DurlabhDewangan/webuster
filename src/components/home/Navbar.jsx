    ...
    <header id="header" className="fixed w-full top-0 z-50 bg-white border-b border-neutral-200">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div className="text-2xl font-bold">WebStudio</div>
        ...
        {/* Mobile Navigation */}
        <div id="mobile-menu" className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden mt-5 pt-2 pb-4 border-t border-neutral-200`}>
